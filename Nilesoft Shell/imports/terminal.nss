menu(type='*' where=(sel.count or wnd.is_taskbar or wnd.is_edit) title='Термінал' sep='top' image=icon.run_with_powershell)
{
	$tip_run_admin=["\xE1A7 Натисни SHIFT щоб запустити " + this.title + " як Адміністратор", tip.warning, 1.0]
