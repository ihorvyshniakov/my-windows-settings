...
{
	menu(title="Застосунки" image=\uE254)
	{
		item(title='Paint' image=\uE116 cmd='mspaint')
		item(title='Visual Studio Code' image cmd='C:\Users\grama\AppData\Local\Programs\Microsoft VS Code\Code.exe')
		item(title='IOBit Unistaller' image cmd='C:\Program Files (x86)\IObit\IObit Uninstaller\IObitUninstaler.exe')
